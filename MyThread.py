...
class MyThread(threading.Thread):
    ...
    def run(self):
        if (self.type == 'android'):
            ...
            # os.system('keytool -genkey -v -keystore android.keystore -alias '+ alias +' -keyalg RSA -keysize 2048 -validity 10000')
            os.system('keytool -genkey -noprompt \
                     ...
                     -storepass '+ password +' \
                     -keypass '+ password +'')
            os.system('npm install recursive-readdir performance-now')
            os.system('cordova platform add android')
            os.system('npm install execa  properties-parser')
            ...
            os.system('npm install superspawn')
            ...
            print('[ i ] ---------------------------------------------------------------')
            print('[ i ] STARTING BUILDING')
            os.system('cordova build ios --buildFlag="-UseModernBuildSystem=0"')
